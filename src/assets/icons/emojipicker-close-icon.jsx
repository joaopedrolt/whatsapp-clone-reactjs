export default function ({ className, onClick }) {
    return (
        <svg viewBox="0 0 24 24" height={26} width={26} preserveAspectRatio="xMidYMid meet" onClick={onClick} className={className} enableBackground="new 0 0 24 24" xmlSpace="preserve">
