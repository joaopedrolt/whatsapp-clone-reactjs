export default function ({ className, onClickFunction }) {
    return (
        <svg viewBox="0 0 53 53" onClick={onClickFunction} className={className} preserveAspectRatio="xMidYMid meet" enableBackground="new 0 0 53 53" xmlSpace="preserve">
            <g>
                <defs>
                ...
                <g clipPath="url(#image-SVGID_2_)">
                    <path fill="#AC44CF" d="M26.5-1.1C11.9-1.1-1.1,5.6-1.1,27.6h55.2C54,8.6,41.1-1.1,26.5-1.1z" />
                    <path fill="#BF59CF" d="M53,26.5H-1.1c0,14.6,13,27.6,27.6,27.6s27.6-13,27.6-27.6C54.1,26.5,53,26.5,53,26.5z" />
                    <rect x={17} y="24.5" fill="#AC44CF" width={18} height={9} /></g></g><g fill="#F5F5F5">
